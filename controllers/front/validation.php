 ...
 * @version 2.2.1
 */
class OsenmpesaValidationModuleFrontController extends ModuleFrontController
{
    ...
    public function postProcess()
    {
        ...
        Tools::redirect('index.php?controller=order-confirmation&id_cart=' . (int)$cart->id .
            ...
            '&key=' . $customer->secure_key . '&id_osenmpesa_system=' . $paysistem->id);
    }
